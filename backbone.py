...
def cropCenter(tensorToCrop, finalShape):
    ...
    cropBorders = np.zeros(2, dtype=int)
    cropBorders[0] = int(diff[0]/2)
    cropBorders[1] = int(diff[1]/2)

    return tensorToCrop[:, :,
           cropBorders[0]:cropBorders[0] + finalShape[2],
           cropBorders[1]:cropBorders[1] + finalShape[3]]
