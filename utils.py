...
def get_whole_tumor_labels(label):
    ...
    label 1 * 155 * 240 * 240
    """
    label = (label == 1) + (label == 2) + (label == 4) + 0 # label 1,2,3,4
    return label
...
def get_tumor_core_labels(label):
    ...
    label = (label == 1) + (label == 4) + 0  # label 1,3,4 = 1
    return label
...
def cal_subject_dice_tumor_core(predicts, target):
    """
        :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
        :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
        :return:
...
def cal_subject_dice_enhancing_core(predicts, target):
    """
            :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
            :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
            :return:
...
def cal_subject_jaccard_whole_tumor(predicts, target):
    """
    :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
    :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
    :return:
    ...
    # tar = ((target > 0) + 0)        # 1D Long np.array 240 * 240
    # # score = cal_iou(predict, tar)
    score = jaccard(predict, tar)
    return score

def cal_subject_jaccard_tumor_core(predicts, target):
    """
        :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
        :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
        :return:
...
def cal_subject_jaccard_enhancing_core(predicts, target):
    """
            :param predicts:    3D Tensor   155 * 240 * 240 (val 0-4)
            :param target:      3D Tensor   155 * 240 * 240 (val 0-4)
            :return:
...
def cal_sen_whole_tumor(predicts,target):
    predicts = np.asarray(predicts.long()).flatten()  # 1d long (155 * 240 * 240)
    target = np.asarray(target.long()).flatten()  # 1d long (155 * 240 * 240)
    ...
    # tar = ((target > 0) + 0)        # 1D Long np.array 240 * 240
    # # score = cal_iou(predict, tar)
    score = sensitivity(predict, tar)
    return score

def cal_sen_core_tumor(predicts, target):
    predicts = np.asarray(predicts.long()).flatten()  # 1d long (155 * 240 * 240)
    target = np.asarray(target.long()).flatten()  # 1d long (155 * 240 * 240)
...
def cal_sen_enhancing_tumor(predicts, target):
    predicts = np.asarray(predicts.long()).flatten()  # 1d long (155 * 240 * 240)
    target = np.asarray(target.long()).flatten()  # 1d long (155 * 240 * 240)
...
def cal_ppv_whole_tumor(predicts, target):
    predicts = np.asarray(predicts.long()).flatten()  # 1d long (155 * 240 * 240)
    target = np.asarray(target.long()).flatten()  # 1d long (155 * 240 * 240)
...
def cal_ppv_core_tumor(predicts, target):
    predicts = np.asarray(predicts.long()).flatten()  # 1d long (155 * 240 * 240)
    target = np.asarray(target.long()).flatten()  # 1d long (155 * 240 * 240)
...
def cal_ppv_enhancing_tumor(predicts, target):
    predicts = np.asarray(predicts.long()).flatten()  # 1d long (155 * 240 * 240)
    target = np.asarray(target.long()).flatten()  # 1d long (155 * 240 * 240)
