...
class BiFPNUnit(nn.Module):
    def __init__(self, n=1, channels=128):
        ...
        self.conv21 = conv_layer(12 * channels, 2 * channels)
        self.conv31 = conv_layer(48 * channels, 4 * channels)

        self.conv12 = conv_layer(6 * channels, 1 * channels)
        self.conv22 = conv_layer(11 * channels, 2 * channels)
        self.conv32 = conv_layer(22 * channels, 4 * channels)
        self.conv42 = conv_layer(36 * channels, 8 * channels)
